...
router.get('/posts/:post_id/categories', authMiddleware, roleMiddleware, postController.getCategoriesForPost);
router.get('/posts/:post_id', authMiddleware, roleMiddleware, postController.getPostByID);
...
router.get('/posts/:post_id/dislike', authMiddleware, postController.getDislikesForPost);
router.post('/posts/:post_id/dislike', authMiddleware, postController.createDislike);
router.delete('/posts/:post_id/dislike', authMiddleware, postController.deleteDislike);
